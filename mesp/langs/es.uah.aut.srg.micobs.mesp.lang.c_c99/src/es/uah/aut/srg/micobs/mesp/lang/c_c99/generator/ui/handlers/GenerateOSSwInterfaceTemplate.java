...
public class GenerateOSSwInterfaceTemplate extends GenerateResourcesHandler {
	...
	protected String getConfirmDialogMessage() {
		return MESPLangC_C99Plugin.INSTANCE.getString("_UI_GenerateOSSwInterfaceTemplate_ConfirmDialog_message");
	}

	@Override
	protected String getModelClassErrorMessage() {
		return MESPLangC_C99Plugin.INSTANCE.getString("_UI_GenerateOSSwInterfaceTemplate_ModelClassError_message");
	}
	...
	protected void generateResources(EObject model, IContainer rootFolder,
		...
		try {
			LanguageCGeneratorUtil.generateOSSwInterfaceTemplate(rootFolder.getLocation().toPortableString() + "/" +
