...
public class CreateOSSwPackagePlatformFoldersTree extends GenerateResourcesHandler {
	...
	protected String getModelClassErrorMessage() {
		return MESPLangC_C99Plugin.INSTANCE.getString("_UI_GenerateOSSwPackagePlatformFoldersTree_ModelClassError_message");
	}
	...
	protected void generateResources(EObject model, IContainer rootFolder,
		...
		MMESPOSSWPPackageFile swPackagePackageFile = (MMESPOSSWPPackageFile)model;
		
		if (swPackagePackageFile.getElement() instanceof MOSSwPackage)
		{
			LanguageCGeneratorUtil.createPlatformFoldersTree((MOSSwPackage)swPackagePackageFile.getElement(),
					rootFolder);
