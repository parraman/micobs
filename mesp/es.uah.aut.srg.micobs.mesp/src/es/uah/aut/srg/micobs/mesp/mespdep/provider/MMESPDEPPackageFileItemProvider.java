...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespdep.MMESPDEPPackageFile} object.
 * @generated
 */
public class MMESPDEPPackageFileItemProvider
	 ...
	 * @generated
	 */
	public MMESPDEPPackageFileItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MMESPDEPPackageFile.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MMESPDEPPackageFile"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_MMESPDEPPackageFile_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mespdepFactory.eINSTANCE.createMMESPDeployment()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mespctoolFactory.eINSTANCE.createMMESPCTOOLPackageElement()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mespctoolFactory.eINSTANCE.createMConstructionTool()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mesposswiFactory.eINSTANCE.createMOSSwInterface()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mesposswpFactory.eINSTANCE.createMOSSwPackage()));
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mesppswpFactory.eINSTANCE.createMPlatformSwPackage()));
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mespswpFactory.eINSTANCE.createMSwPackage()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mespswpFactory.eINSTANCE.createMDriverSwPackage()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mespswpFactory.eINSTANCE.createMAbstractSwPackage()));
