...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespswp.MParameterSWPSPSwitch} object.
 * 
 * @generated
 */
public class MParameterSWPSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MParameterSWPSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MParameterSWPSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MParameterSWPSPSwitch_type") :
			getString("_UI_MParameterSWPSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MParameterSWPSPSwitch.class)) {
