...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespdep.MMESPDeployedDevice} object.
 * 
 * @generated
 */
public class MMESPDeployedDeviceItemProvider
	 ...
	 * @generated
	 */
	public MMESPDeployedDeviceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MMESPDeployedDevice_device_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MMESPDeployedDevice_device_feature", "_UI_MMESPDeployedDevice_type"),
				 mespdepPackage.Literals.MMESP_DEPLOYED_DEVICE__DEVICE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mespdepPackage.Literals.MMESP_DEPLOYED_DEVICE__PARAMETER_VALUE_ASSIGNMENTS);
		}
	...
	/**
	 * This returns MMESPDeployedDevice.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MMESPDeployedDevice"));
	}
	...
	public String getText(Object object) {
		String label = ((MMESPDeployedDevice)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MMESPDeployedDevice_type") :
			getString("_UI_MMESPDeployedDevice_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MMESPDeployedDevice.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mespdepPackage.Literals.MMESP_DEPLOYED_DEVICE__PARAMETER_VALUE_ASSIGNMENTS,
