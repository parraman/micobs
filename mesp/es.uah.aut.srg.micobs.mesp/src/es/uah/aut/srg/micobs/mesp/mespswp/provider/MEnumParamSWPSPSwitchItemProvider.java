...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespswp.MEnumParamSWPSPSwitch} object.
 * 
 * @generated
 */
public class MEnumParamSWPSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MEnumParamSWPSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MEnumParamSWPSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MEnumParamSWPSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MEnumParamSWPSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MEnumParamSWPSPSwitch_type") :
			getString("_UI_MEnumParamSWPSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MEnumParamSWPSPSwitch.class)) {
