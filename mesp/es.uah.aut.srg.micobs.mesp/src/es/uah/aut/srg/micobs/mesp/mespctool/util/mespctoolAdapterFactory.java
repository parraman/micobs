 ...
 * @generated
 */
public class mespctoolAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public mespctoolAdapterFactory() {
	 ...
	 * @generated
	 */
	protected mespctoolSwitch<Adapter> modelSwitch =
		new mespctoolSwitch<Adapter>() {
			@Override
			public Adapter caseMConstructionTool(MConstructionTool object) {
				return createMConstructionToolAdapter();
			}
			@Override
			public Adapter caseMMESPCTOOLPackageFile(MMESPCTOOLPackageFile object) {
				return createMMESPCTOOLPackageFileAdapter();
			}
			@Override
			public Adapter caseMMESPCTOOLPackageElement(MMESPCTOOLPackageElement object) {
				return createMMESPCTOOLPackageElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.micobs.mesp.mespctool.MConstructionTool <em>MConstructionTool</em>}'.
	 * @return the new adapter.
	 * @see es.uah.aut.srg.micobs.mesp.mespctool.MConstructionTool
	 * @generated
	 */
	public Adapter createMConstructionToolAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.micobs.mesp.mespctool.MMESPCTOOLPackageFile <em>MMESPCTOOLPackageFile</em>}'.
	 * @return the new adapter.
	 * @see es.uah.aut.srg.micobs.mesp.mespctool.MMESPCTOOLPackageFile
	 * @generated
	 */
	public Adapter createMMESPCTOOLPackageFileAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.micobs.mesp.mespctool.MMESPCTOOLPackageElement <em>MMESPCTOOLPackageElement</em>}'.
	 * @return the new adapter.
	 * @see es.uah.aut.srg.micobs.mesp.mespctool.MMESPCTOOLPackageElement
	 * @generated
	 */
	public Adapter createMMESPCTOOLPackageElementAdapter() {
		return null;
	}
