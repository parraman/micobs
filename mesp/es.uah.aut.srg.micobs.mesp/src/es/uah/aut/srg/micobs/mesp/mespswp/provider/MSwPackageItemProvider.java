...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespswp.MSwPackage} object.
 * 
 * @generated
 */
public class MSwPackageItemProvider
	 ...
	 * @generated
	 */
	public MSwPackageItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MSwPackage.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MSwPackage"));
	}
	...
	public String getText(Object object) {
		String label = ((MSwPackage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MSwPackage_type") :
			getString("_UI_MSwPackage_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MSwPackage.class)) {
