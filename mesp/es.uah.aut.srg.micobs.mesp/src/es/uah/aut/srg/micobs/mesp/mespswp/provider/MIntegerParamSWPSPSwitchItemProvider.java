...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespswp.MIntegerParamSWPSPSwitch} object.
 * 
 * @generated
 */
public class MIntegerParamSWPSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MIntegerParamSWPSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MIntegerParamSWPSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MIntegerParamSWPSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MIntegerParamSWPSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MIntegerParamSWPSPSwitch_type") :
			getString("_UI_MIntegerParamSWPSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MIntegerParamSWPSPSwitch.class)) {
