...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mesp.mespswp.MBooleanParamSWPSPSwitch} object.
 * 
 * @generated
 */
public class MBooleanParamSWPSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MBooleanParamSWPSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MBooleanParamSWPSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MBooleanParamSWPSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MBooleanParamSWPSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MBooleanParamSWPSPSwitch_type") :
			getString("_UI_MBooleanParamSWPSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MBooleanParamSWPSPSwitch.class)) {
