...
@Singleton
public class SWIGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class MMESPSWIPackageFileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MMESPSWIPackageFile");
		...
		private final RuleCall cElementMMESPSWIPackageElementParserRuleCall_4_0 = (RuleCall)cElementAssignment_4.eContents().get(0);
		...
		public RuleCall getElementMMESPSWIPackageElementParserRuleCall_4_0() { return cElementMMESPSWIPackageElementParserRuleCall_4_0; }
	}

	public class MMESPSWIPackageElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MMESPSWIPackageElement");
		private final RuleCall cMSwInterfaceParserRuleCall = (RuleCall)rule.eContents().get(1);
		...
		//MSwInterface
		public RuleCall getMSwInterfaceParserRuleCall() { return cMSwInterfaceParserRuleCall; }
	}

	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VersionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.Version");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VersionedQualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.VersionedQualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VersionedQualifiedReferenceNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.VersionedQualifiedReferenceName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MSwInterfaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MSwInterface");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cSwinterfaceKeyword_0 = (Keyword)cGroup.eContents().get(0);
		...
		private final CrossReference cExtendsMSwInterfaceCrossReference_2_1_0 = (CrossReference)cExtendsAssignment_2_1.eContents().get(0);
		private final RuleCall cExtendsMSwInterfaceVersionedQualifiedNameParserRuleCall_2_1_0_1 = (RuleCall)cExtendsMSwInterfaceCrossReference_2_1_0.eContents().get(1);
		private final Group cGroup_2_2 = (Group)cGroup_2.eContents().get(2);
		private final Keyword cCommaKeyword_2_2_0 = (Keyword)cGroup_2_2.eContents().get(0);
		private final Assignment cExtendsAssignment_2_2_1 = (Assignment)cGroup_2_2.eContents().get(1);
		private final CrossReference cExtendsMSwInterfaceCrossReference_2_2_1_0 = (CrossReference)cExtendsAssignment_2_2_1.eContents().get(0);
		private final RuleCall cExtendsMSwInterfaceVersionedQualifiedNameParserRuleCall_2_2_1_0_1 = (RuleCall)cExtendsMSwInterfaceCrossReference_2_2_1_0.eContents().get(1);
		...
		private final RuleCall cParametersMParameterParserRuleCall_4_2_3_0 = (RuleCall)cParametersAssignment_4_2_3.eContents().get(0);
		...
		private final Keyword cResourcesKeyword_4_3_1 = (Keyword)cGroup_4_3.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_4_3_2 = (Keyword)cGroup_4_3.eContents().get(2);
		private final Assignment cProvidedResourcesAssignment_4_3_3 = (Assignment)cGroup_4_3.eContents().get(3);
		private final RuleCall cProvidedResourcesMProvidedResourceParserRuleCall_4_3_3_0 = (RuleCall)cProvidedResourcesAssignment_4_3_3.eContents().get(0);
		...
		private final Keyword cRequiresKeyword_4_4_0 = (Keyword)cGroup_4_4.eContents().get(0);
		private final Keyword cColonEqualsSignKeyword_4_4_1 = (Keyword)cGroup_4_4.eContents().get(1);
		private final Assignment cRequiresAssignment_4_4_2 = (Assignment)cGroup_4_4.eContents().get(2);
		private final CrossReference cRequiresMSwInterfaceCrossReference_4_4_2_0 = (CrossReference)cRequiresAssignment_4_4_2.eContents().get(0);
		private final RuleCall cRequiresMSwInterfaceVersionedQualifiedNameParserRuleCall_4_4_2_0_1 = (RuleCall)cRequiresMSwInterfaceCrossReference_4_4_2_0.eContents().get(1);
		...
		private final Assignment cRequiresAssignment_4_4_3_1 = (Assignment)cGroup_4_4_3.eContents().get(1);
		private final CrossReference cRequiresMSwInterfaceCrossReference_4_4_3_1_0 = (CrossReference)cRequiresAssignment_4_4_3_1.eContents().get(0);
		private final RuleCall cRequiresMSwInterfaceVersionedQualifiedNameParserRuleCall_4_4_3_1_0_1 = (RuleCall)cRequiresMSwInterfaceCrossReference_4_4_3_1_0.eContents().get(1);
		...
		private final Keyword cRequiredKeyword_4_5_0 = (Keyword)cGroup_4_5.eContents().get(0);
		private final Keyword cOsapiKeyword_4_5_1 = (Keyword)cGroup_4_5.eContents().get(1);
		private final Keyword cColonEqualsSignKeyword_4_5_2 = (Keyword)cGroup_4_5.eContents().get(2);
		private final Assignment cRequiredOSAPIAssignment_4_5_3 = (Assignment)cGroup_4_5.eContents().get(3);
		private final CrossReference cRequiredOSAPIMOperatingSystemAPICrossReference_4_5_3_0 = (CrossReference)cRequiredOSAPIAssignment_4_5_3.eContents().get(0);
		private final RuleCall cRequiredOSAPIMOperatingSystemAPIVersionedQualifiedNameParserRuleCall_4_5_3_0_1 = (RuleCall)cRequiredOSAPIMOperatingSystemAPICrossReference_4_5_3_0.eContents().get(1);
		...
		//'swinterface'
		public Keyword getSwinterfaceKeyword_0() { return cSwinterfaceKeyword_0; }
		...
		//[MSwInterface|VersionedQualifiedName]
		public CrossReference getExtendsMSwInterfaceCrossReference_2_1_0() { return cExtendsMSwInterfaceCrossReference_2_1_0; }

		//VersionedQualifiedName
		public RuleCall getExtendsMSwInterfaceVersionedQualifiedNameParserRuleCall_2_1_0_1() { return cExtendsMSwInterfaceVersionedQualifiedNameParserRuleCall_2_1_0_1; }
		...
		//[MSwInterface|VersionedQualifiedName]
		public CrossReference getExtendsMSwInterfaceCrossReference_2_2_1_0() { return cExtendsMSwInterfaceCrossReference_2_2_1_0; }

		//VersionedQualifiedName
		public RuleCall getExtendsMSwInterfaceVersionedQualifiedNameParserRuleCall_2_2_1_0_1() { return cExtendsMSwInterfaceVersionedQualifiedNameParserRuleCall_2_2_1_0_1; }
		...
		//MParameter
		public RuleCall getParametersMParameterParserRuleCall_4_2_3_0() { return cParametersMParameterParserRuleCall_4_2_3_0; }
		...
		//'resources'
		public Keyword getResourcesKeyword_4_3_1() { return cResourcesKeyword_4_3_1; }

		//'{'
		public Keyword getLeftCurlyBracketKeyword_4_3_2() { return cLeftCurlyBracketKeyword_4_3_2; }

		//providedResources+=MProvidedResource+
		public Assignment getProvidedResourcesAssignment_4_3_3() { return cProvidedResourcesAssignment_4_3_3; }

		//MProvidedResource
		public RuleCall getProvidedResourcesMProvidedResourceParserRuleCall_4_3_3_0() { return cProvidedResourcesMProvidedResourceParserRuleCall_4_3_3_0; }
		...
		//'requires'
		public Keyword getRequiresKeyword_4_4_0() { return cRequiresKeyword_4_4_0; }

		//':='
		public Keyword getColonEqualsSignKeyword_4_4_1() { return cColonEqualsSignKeyword_4_4_1; }

		//requires+=[MSwInterface|VersionedQualifiedName]
		public Assignment getRequiresAssignment_4_4_2() { return cRequiresAssignment_4_4_2; }

		//[MSwInterface|VersionedQualifiedName]
		public CrossReference getRequiresMSwInterfaceCrossReference_4_4_2_0() { return cRequiresMSwInterfaceCrossReference_4_4_2_0; }

		//VersionedQualifiedName
		public RuleCall getRequiresMSwInterfaceVersionedQualifiedNameParserRuleCall_4_4_2_0_1() { return cRequiresMSwInterfaceVersionedQualifiedNameParserRuleCall_4_4_2_0_1; }
		...
		//requires+=[MSwInterface|VersionedQualifiedName]
		public Assignment getRequiresAssignment_4_4_3_1() { return cRequiresAssignment_4_4_3_1; }

		//[MSwInterface|VersionedQualifiedName]
		public CrossReference getRequiresMSwInterfaceCrossReference_4_4_3_1_0() { return cRequiresMSwInterfaceCrossReference_4_4_3_1_0; }

		//VersionedQualifiedName
		public RuleCall getRequiresMSwInterfaceVersionedQualifiedNameParserRuleCall_4_4_3_1_0_1() { return cRequiresMSwInterfaceVersionedQualifiedNameParserRuleCall_4_4_3_1_0_1; }
		...
		//'required'
		public Keyword getRequiredKeyword_4_5_0() { return cRequiredKeyword_4_5_0; }

		//'osapi'
		public Keyword getOsapiKeyword_4_5_1() { return cOsapiKeyword_4_5_1; }

		//':='
		public Keyword getColonEqualsSignKeyword_4_5_2() { return cColonEqualsSignKeyword_4_5_2; }

		//requiredOSAPI=[pdl::MOperatingSystemAPI|VersionedQualifiedName]
		public Assignment getRequiredOSAPIAssignment_4_5_3() { return cRequiredOSAPIAssignment_4_5_3; }

		//[pdl::MOperatingSystemAPI|VersionedQualifiedName]
		public CrossReference getRequiredOSAPIMOperatingSystemAPICrossReference_4_5_3_0() { return cRequiredOSAPIMOperatingSystemAPICrossReference_4_5_3_0; }

		//VersionedQualifiedName
		public RuleCall getRequiredOSAPIMOperatingSystemAPIVersionedQualifiedNameParserRuleCall_4_5_3_0_1() { return cRequiredOSAPIMOperatingSystemAPIVersionedQualifiedNameParserRuleCall_4_5_3_0_1; }
	...
	public class MProvidedResourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MProvidedResource");
	...
	public class MQuantifiableResourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MQuantifiableResource");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MInstantiableResourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MInstantiableResource");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameter");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MIntegerParameterSingleExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MIntegerParameterSingleExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MEnumParameterDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParameterDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MEnumParameterSingleExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParameterSingleExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cConstantAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cConstantConstKeyword_0_0 = (Keyword)cConstantAssignment_0.eContents().get(0);
		private final Keyword cEnumKeyword_1 = (Keyword)cGroup.eContents().get(1);
	...
	public class MRealParameterSingleExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MRealParameterSingleExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cConstantAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cConstantConstKeyword_0_0 = (Keyword)cConstantAssignment_0.eContents().get(0);
	...
	public class MEnumParameterLiteralRuleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParameterLiteralRule");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MEnumParameterLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParameterLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MEnumParamIntegerLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParamIntegerLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MEnumParamRealLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParamRealLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MEnumParamStringLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MEnumParamStringLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MBooleanParameterSingleExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MBooleanParameterSingleExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cConstantAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cConstantConstKeyword_0_0 = (Keyword)cConstantAssignment_0.eContents().get(0);
	...
	public class MStringParameterSingleExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MStringParameterSingleExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cConstantAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cConstantConstKeyword_0_0 = (Keyword)cConstantAssignment_0.eContents().get(0);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class INTEGERElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.INTEGER");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class REALElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.REAL");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValue");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MParameterValueLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueLiteral");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MParameterValueBooleanLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueBooleanLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueStringLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueStringLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueIntegerLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueIntegerLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueRealLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueRealLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueRefObjectElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueRefObject");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValuePARElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValuePAR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueTERMElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueTERM");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterRangeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterRange");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MParameterOCRElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterOCR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterOORElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterOOR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterCORElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterCOR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterCCRElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterCCR");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MParameterValueExpressionOperatorsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueExpressionOperators");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MParameterValueTERMOperatorsElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.MParameterValueTERMOperators");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final MMESPSWIPackageFileElements pMMESPSWIPackageFile;
	private final MMESPSWIPackageElementElements pMMESPSWIPackageElement;
	...
	private final MSwInterfaceElements pMSwInterface;
	...
	@Inject
	public SWIGrammarAccess(GrammarProvider grammarProvider,
		TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pMMESPSWIPackageFile = new MMESPSWIPackageFileElements();
		this.pMMESPSWIPackageElement = new MMESPSWIPackageElementElements();
		...
		this.pMSwInterface = new MSwInterfaceElements();
		...
		this.tHEXADECIMAL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "es.uah.aut.srg.micobs.mesp.lang.SWI.HEXADECIMAL");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("es.uah.aut.srg.micobs.mesp.lang.SWI".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	imports+=[common::MCommonPackage|QualifiedName] ';')*
	//	element=MMESPSWIPackageElement;
	public MMESPSWIPackageFileElements getMMESPSWIPackageFileAccess() {
		return pMMESPSWIPackageFile;
	}
	
	public ParserRule getMMESPSWIPackageFileRule() {
		return getMMESPSWIPackageFileAccess().getRule();
	}

	//MMESPSWIPackageElement:
	//	MSwInterface;
	public MMESPSWIPackageElementElements getMMESPSWIPackageElementAccess() {
		return pMMESPSWIPackageElement;
	}
	
	public ParserRule getMMESPSWIPackageElementRule() {
		return getMMESPSWIPackageElementAccess().getRule();
	}
	...
	//	& ('required' 'osapi' ':=' requiredOSAPI=[pdl::MOperatingSystemAPI|VersionedQualifiedName] ';')?)
	//	'}' ';';
	public MSwInterfaceElements getMSwInterfaceAccess() {
		return pMSwInterface;
	}
	
	public ParserRule getMSwInterfaceRule() {
		return getMSwInterfaceAccess().getRule();
	}
