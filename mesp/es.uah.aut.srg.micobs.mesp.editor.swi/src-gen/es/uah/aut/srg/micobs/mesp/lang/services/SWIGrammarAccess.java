...
public class SWIGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MMESPSWIPackageFileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MMESPSWIPackageFile");
	...
	public class MMESPSWIPackageElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MMESPSWIPackageElement");
	...
	public class MSwInterfaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MSwInterface");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private MMESPSWIPackageFileElements pMMESPSWIPackageFile;
	private MMESPSWIPackageElementElements pMMESPSWIPackageElement;
	...
	private MSwInterfaceElements pMSwInterface;
	...
	public MMESPSWIPackageFileElements getMMESPSWIPackageFileAccess() {
		return (pMMESPSWIPackageFile != null) ? pMMESPSWIPackageFile : (pMMESPSWIPackageFile = new MMESPSWIPackageFileElements());
	}
	...
	public MMESPSWIPackageElementElements getMMESPSWIPackageElementAccess() {
		return (pMMESPSWIPackageElement != null) ? pMMESPSWIPackageElement : (pMMESPSWIPackageElement = new MMESPSWIPackageElementElements());
	}
	...
	public MSwInterfaceElements getMSwInterfaceAccess() {
		return (pMSwInterface != null) ? pMSwInterface : (pMSwInterface = new MSwInterfaceElements());
	}
