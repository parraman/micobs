...
public class CleanMainFolders extends GenerateResourcesHandler {
	...
	protected String getConfirmDialogMessage() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_UI_CleanMainFolders_ConfirmDialog_message");
	}
	...
	protected List <IResource> getResourcesToErase(IContainer rootFolder,
		...
		IFolder mainFolder = rootFolder.getFolder(
				new Path(MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_main_foldername")));
	...
	protected String getModelClassErrorMessage() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_UI_CleanMainFolders_ModelClassError_message");
	}
