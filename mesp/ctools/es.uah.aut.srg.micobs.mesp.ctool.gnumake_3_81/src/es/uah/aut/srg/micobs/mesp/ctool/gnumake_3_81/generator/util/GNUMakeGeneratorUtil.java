 ...
 ******************************************************************************/
package es.uah.aut.srg.micobs.mesp.ctool.gnumake_3_81.generator.util;
...
import es.uah.aut.srg.micobs.mesp.ctool.gnumake_3_81.util.GNUMakeStringHelper;
...
public class GNUMakeGeneratorUtil {
	...
	public static void createMESPDeploymentProjectSkeleton(MMESPDEPPackageFile depPackageFile, IContainer rootFolder)
	{
		FileHelper.createFolder(rootFolder,
				MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_swpackages_foldername"));
		
		FileHelper.createFolder(rootFolder,
				MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_osswpackages_foldername"));
		
		FileHelper.createFolder(rootFolder,
				MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_swinterfaces_foldername"));
		
		FileHelper.createFolder(rootFolder,
				MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_osswinterfaces_foldername"));
		
		FileHelper.createFolder(rootFolder,
				MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_platformswpackages_foldername"));
			...
			MMESPDeployment deployment, IContainer rootFolder)
	{
		...
		{
			FileHelper.createFolder(rootFolder,
					MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_main_foldername") + "/" +
					name + "/" + MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPPackageProject_include_foldername") + "/" +
					MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_main_foldername"));	

			FileHelper.createFolder(rootFolder,
					MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_main_foldername") + "/" +
					name + "/" + MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPPackageProject_src_foldername"));	
		}
	}
			...
			MMESPDeployment deployment, IContainer rootFolder)
	{
		...
		{
			FileHelper.createFolder(rootFolder,
					MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_config_foldername") + "/" +
					name + "/" + MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPPackageProject_public_foldername"));	
		}
	}
			...
			IProgressMonitor monitor)
	{
		XpandUtil.generate(containerName, 
			model, 
			metamodel, 
			"template::BuildGNUMake_3_81SwPackageDefsMk::main",
			false);
	}
			...
			IProgressMonitor monitor)
	{
		XpandUtil.generate(containerName, 
			model, 
			metamodel, 
			"template::BuildGNUMake_3_81OSSwPackageDefsMk::main",
			false);
	}
			...
			IProgressMonitor monitor)
	{
		XpandUtil.generate(containerName, 
			model, 
			metamodel, 
			"template::BuildGNUMake_3_81PlatformSwPackageDefsMk::main",
			false);
	}
			...
			IProgressMonitor monitor)
	{
		XpandUtil.generate(containerName, 
			model, 
			metamodel, 
			"template::BuildGNUMake_3_81DeploymentConfigurationFiles::main",
			false);
	}
			...
			IProgressMonitor monitor)
	{
		XpandUtil.generate(containerName, 
			model, 
			metamodel, 
			"template::BuildGNUMake_3_81MainDefsMk::main",
			false);
	}
			...
			IProgressMonitor monitor)
	{
			XpandUtil.generate(containerName, 
					model, 
					metamodel, 
					"template::BuildGNUMake_3_81DeploymentMakefiles::main",
					false,
					alternative,
					deploymentPlatform);			
	}
