...
import es.uah.aut.srg.micobs.mesp.mespctool.generator.ui.handlers.GenerateOSSwPackageConstructionFiles;
 ...
 *
 */
public class GenerateOSSwPackageGNUMakeConstructionFiles extends GenerateOSSwPackageConstructionFiles {
	...
	protected void generateResources(EObject model, IContainer rootFolder,
		...
		try {
			GNUMakeGeneratorUtil.generateMOSSwPackageDefsMk(rootFolder.getLocation().toPortableString(), 
				model, 
