...
public class UpdateDeploymentPlatformSwPackages extends UpdateRemoteFoldersHandler {
	...
	protected String getConfirmDialogMessage() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_UI_UpdateDeploymentPlatformSwPackages_ConfirmDialog_message");
	}
	
	@Override
	protected String getModelClassErrorMessage() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_UI_UpdateDeploymentPlatformSwPackages_ModelClassError_message");
	}
