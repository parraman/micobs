...
public class CleanConfigFolders extends GenerateResourcesHandler {
	...
	protected String getConfirmDialogMessage() {
		return GNUMakePlugin.INSTANCE.getString("_UI_CreateConfigFolders_ConfirmDialog_message");
	}
	...
	protected List <IResource> getResourcesToErase(IContainer rootFolder,
		...
		IFolder mainFolder = rootFolder.getFolder(
				new Path(GNUMakePlugin.INSTANCE.getString("_MESPDeploymentProject_config_foldername")));
	...
	protected String getModelClassErrorMessage() {
		return GNUMakePlugin.INSTANCE.getString("_UI_CreateConfigFolders_ModelClassError_message");
	}
