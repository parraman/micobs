 ...
 ******************************************************************************/
package es.uah.aut.srg.micobs.mesp.ctool.gnumake_3_81.util;
...
public class GNUMakeStringHelper {
	...
	public static String getOSSwPackagesFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_osswpackages_foldername");
	}
	...
	public static String getSwPackagesFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_swpackages_foldername");
	}
	...
	public static String getOSSwInterfacesFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_osswinterfaces_foldername");
	}
	...
	public static String getSwInterfacesFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_swinterfaces_foldername");
	}
	...
	public static String getPlatformSwPackagesFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_platformswpackages_foldername");
	}
	...
	public static String getMainFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_main_foldername");
	}
	...
	public static String getConfigFolder() {
		return MESPCToolGNUMake_3_81Plugin.INSTANCE.getString("_MESPDeploymentProject_config_foldername");
	}
	...
	public static Set<String> getBinaryFolderNames(MMESPDeployment deployment)
	{
		...
		else
		{
			for (MMESPDeploymentAlternative alternative : MESPUtil.getDefault().getLeafDeploymentAlternatives(deployment))
			{
				for (MMESPDeploymentPlatform platform : alternative.getDeploymentPlatforms())
				{
					for (MMESPSwPackageDeployment swpd : MESPUtil.getDefault().getAllDeployedSwPackagesFromAlternative(alternative))
					{
						results.add(getDeploymentFolderName(deployment,
