...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.common.MEnumParamStringLiteral} object.
 * @generated
 */
public class MEnumParamStringLiteralItemProvider
	 ...
	 * @generated
	 */
	public MEnumParamStringLiteralItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MEnumParamStringLiteral_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MEnumParamStringLiteral_value_feature", "_UI_MEnumParamStringLiteral_type"),
				 commonPackage.Literals.MENUM_PARAM_STRING_LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns MEnumParamStringLiteral.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MEnumParamStringLiteral"));
	}
	...
	public String getText(Object object) {
		String label = ((MEnumParamStringLiteral)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MEnumParamStringLiteral_type") :
			getString("_UI_MEnumParamStringLiteral_type") + " " + label;
	}
