...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.common.MCommonPackageReferencingElement} object.
 * @generated
 */
public class MCommonPackageReferencingElementItemProvider
	 ...
	 * @generated
	 */
	public MCommonPackageReferencingElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MCommonPackageReferencingElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MCommonPackageReferencingElement_type") :
			getString("_UI_MCommonPackageReferencingElement_type") + " " + label;
	}
