...
/**
 * This class is a modified version of the original
 * {@link AdapterFactoryLabelProvided} that also provided styled cell labels
 * by extending the {@link StyledCellLabelProvider} class.
 *
 */
public class MICOBSAdapterFactoryLabelProvider 
	extends StyledCellLabelProvider 
	implements IStyledLabelProvider, ILabelProvider, ITableLabelProvider, INotifyChangedListener
{
	...
	private static final Class<?> IStyledTextProviderClass = IStyledTextProvider.class;
	 ...
	 *  @param adapterFactory an adapter factory that yield adapters that implement the various item label provider interfaces.
	 */
	public MICOBSAdapterFactoryLabelProvider(AdapterFactory adapterFactory)
	{
	...
	public StyledString getStyledText(Object object) {
	    // Get the adapter from the factory.
	    //
		IStyledTextProvider stypedLabelProvider = (IStyledTextProvider)adapterFactory.adapt(object, IStyledTextProviderClass);
	    
	    return stypedLabelProvider != null ?
	    	stypedLabelProvider.getStyledText(object) :
    		convertToStyledString(getText(object));
	}
}