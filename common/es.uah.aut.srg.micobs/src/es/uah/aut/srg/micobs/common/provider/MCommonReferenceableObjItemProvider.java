...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.common.MCommonReferenceableObj} object.
 * @generated
 */
public class MCommonReferenceableObjItemProvider
	 ...
	 * @generated
	 */
	public MCommonReferenceableObjItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MCommonReferenceableObj)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MCommonReferenceableObj_type") :
			getString("_UI_MCommonReferenceableObj_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MCommonReferenceableObj.class)) {
