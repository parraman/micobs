...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.pdl.MDevice} object.
 * 
 * @generated
 */
public class MDeviceItemProvider
	 ...
	 * @generated
	 */
	public MDeviceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(pdlPackage.Literals.MDEVICE__PARAMETERS);
		}
	...
	/**
	 * This returns MDevice.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MDevice"));
	}
	...
	public String getText(Object object) {
		String label = ((MDevice)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MDevice_type") :
			getString("_UI_MDevice_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MDevice.class)) {
			case pdlPackage.MDEVICE__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(pdlPackage.Literals.MDEVICE__PARAMETERS,
