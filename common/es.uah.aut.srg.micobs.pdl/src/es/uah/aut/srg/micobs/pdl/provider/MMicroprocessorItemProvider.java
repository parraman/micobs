...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.pdl.MMicroprocessor} object.
 * @generated
 */
public class MMicroprocessorItemProvider
	 ...
	 * @generated
	 */
	public MMicroprocessorItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MMicroprocessor_architecture_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MMicroprocessor_architecture_feature", "_UI_MMicroprocessor_type"),
				 pdlPackage.Literals.MMICROPROCESSOR__ARCHITECTURE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(pdlPackage.Literals.MMICROPROCESSOR__PARAMETERS);
		}
	...
	/**
	 * This returns MMicroprocessor.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MMicroprocessor"));
	}
	...
	public String getText(Object object) {
		String label = ((MMicroprocessor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MMicroprocessor_type") :
			getString("_UI_MMicroprocessor_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MMicroprocessor.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(pdlPackage.Literals.MMICROPROCESSOR__PARAMETERS,
