...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.pdl.MParameterOSSPSwitch} object.
 * 
 * @generated
 */
public class MParameterOSSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MParameterOSSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MParameterOSSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MParameterOSSPSwitch_type") :
			getString("_UI_MParameterOSSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MParameterOSSPSwitch.class)) {
