...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.pdl.MRealParamOSSPSwitch} object.
 * 
 * @generated
 */
public class MRealParamOSSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MRealParamOSSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MRealParamOSSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MRealParamOSSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MRealParamOSSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MRealParamOSSPSwitch_type") :
			getString("_UI_MRealParamOSSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MRealParamOSSPSwitch.class)) {
