...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.pdl.MBooleanParamOSSPSwitch} object.
 * 
 * @generated
 */
public class MBooleanParamOSSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MBooleanParamOSSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MBooleanParamOSSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MBooleanParamOSSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MBooleanParamOSSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MBooleanParamOSSPSwitch_type") :
			getString("_UI_MBooleanParamOSSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MBooleanParamOSSPSwitch.class)) {
