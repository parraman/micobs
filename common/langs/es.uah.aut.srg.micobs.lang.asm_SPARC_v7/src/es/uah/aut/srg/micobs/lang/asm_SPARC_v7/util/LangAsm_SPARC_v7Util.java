 ...
 ******************************************************************************/
package es.uah.aut.srg.micobs.lang.asm_SPARC_v7.util;

import es.uah.aut.srg.micobs.common.MCommonPackageElement;
import es.uah.aut.srg.micobs.lang.asm_SPARC_v7.plugin.LangAsm_SPARC_v7Plugin;
 ...
 *
 */
public class LangAsm_SPARC_v7Util {
			...
			try {
				MCommonPackageElement element = 
						SystemLibraryManager.getLibraryManager().getElement(
								...
								LANGUAGE_ASM_SPARC_V7_URI, LANGUAGE_ASM_SPARC_V7_VERSION);
				if (element != null &&
				...
				LangAsm_SPARC_v7Plugin.INSTANCE.log(e);
			}
		}
		return asm_sparc_v7;
	}
