...
import es.uah.aut.srg.micobs.mclev.lang.validation.CMPJavaValidator;
import es.uah.aut.srg.micobs.xtext.MICOBSQuickFixProvider;

public class CMPQuickfixProvider extends MICOBSQuickFixProvider {

	@Fix(CMPJavaValidator.IMPROPER_CMPSUPPORTEDPLATFORM_NAME)
	public void properSwPackageSupportedPlatformName(final Issue issue, IssueResolutionAcceptor acceptor) {
		...
		acceptor.accept(issue, "Change name to '" + issue.getData()[1] + "'" , 
				"Change the name of the component supported platform to the recommended name '" +
