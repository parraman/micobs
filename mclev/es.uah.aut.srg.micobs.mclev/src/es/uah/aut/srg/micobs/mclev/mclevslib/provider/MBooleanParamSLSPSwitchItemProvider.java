...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevslib.MBooleanParamSLSPSwitch} object.
 * @generated
 */
public class MBooleanParamSLSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MBooleanParamSLSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MBooleanParamSLSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MBooleanParamSLSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MBooleanParamSLSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MBooleanParamSLSPSwitch_type") :
			getString("_UI_MBooleanParamSLSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MBooleanParamSLSPSwitch.class)) {
