...
/**
 * An implementation of the model object '<em><b>MParameterSLSPSwitch</b></em>'.
 * 
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevslib.impl.MParameterSLSPSwitchImpl#getCases <em>Cases</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class MParameterSLSPSwitchImpl extends MParameterImpl implements MParameterSLSPSwitch {
	/**
	 ...
	 * @generated
	 */
	protected MParameterSLSPSwitchImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return mclevslibPackage.Literals.MPARAMETER_SLSP_SWITCH;
	}
	...
	public EList<MParameterSLSPSwitchCase> getCases() {
		if (cases == null) {
			cases = new EObjectContainmentEList<MParameterSLSPSwitchCase>(MParameterSLSPSwitchCase.class, this, mclevslibPackage.MPARAMETER_SLSP_SWITCH__CASES);
		}
		return cases;
	}
