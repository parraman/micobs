...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevcmp.MBooleanParamCSPSwitch} object.
 * @generated
 */
public class MBooleanParamCSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MBooleanParamCSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MBooleanParamCSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MBooleanParamCSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MBooleanParamCSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MBooleanParamCSPSwitch_type") :
			getString("_UI_MBooleanParamCSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MBooleanParamCSPSwitch.class)) {
