...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevslib.MAbstractServiceLibrary} object.
 * @generated
 */
public class MAbstractServiceLibraryItemProvider
	 ...
	 * @generated
	 */
	public MAbstractServiceLibraryItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MAbstractServiceLibrary.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MAbstractServiceLibrary"));
	}
	...
	public String getText(Object object) {
		String label = ((MAbstractServiceLibrary)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MAbstractServiceLibrary_type") :
			getString("_UI_MAbstractServiceLibrary_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MAbstractServiceLibrary.class)) {
