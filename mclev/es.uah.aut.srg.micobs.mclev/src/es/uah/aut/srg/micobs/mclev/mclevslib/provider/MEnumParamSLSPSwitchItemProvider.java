...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevslib.MEnumParamSLSPSwitch} object.
 * @generated
 */
public class MEnumParamSLSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MEnumParamSLSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MEnumParamSLSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MEnumParamSLSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MEnumParamSLSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MEnumParamSLSPSwitch_type") :
			getString("_UI_MEnumParamSLSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MEnumParamSLSPSwitch.class)) {
