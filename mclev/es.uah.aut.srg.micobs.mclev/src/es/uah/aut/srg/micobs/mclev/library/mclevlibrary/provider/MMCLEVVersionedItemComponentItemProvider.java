...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.library.mclevlibrary.MMCLEVVersionedItemComponent} object.
 * @generated
 */
public class MMCLEVVersionedItemComponentItemProvider
	 ...
	 * @generated
	 */
	public MMCLEVVersionedItemComponentItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MMCLEVVersionedItemComponent_swPackageURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MMCLEVVersionedItemComponent_swPackageURI_feature", "_UI_MMCLEVVersionedItemComponent_type"),
				 mclevlibraryPackage.Literals.MMCLEV_VERSIONED_ITEM_COMPONENT__SW_PACKAGE_URI,
				 true,
				 false,
				 false,
	...
	protected void addSwPackageVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MMCLEVVersionedItemComponent_swPackageVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MMCLEVVersionedItemComponent_swPackageVersion_feature", "_UI_MMCLEVVersionedItemComponent_type"),
				 mclevlibraryPackage.Literals.MMCLEV_VERSIONED_ITEM_COMPONENT__SW_PACKAGE_VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((MMCLEVVersionedItemComponent)object).getVersion();
