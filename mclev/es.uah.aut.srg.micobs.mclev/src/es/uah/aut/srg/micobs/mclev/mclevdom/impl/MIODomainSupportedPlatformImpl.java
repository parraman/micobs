...
/**
 * An implementation of the model object '<em><b>MIO Domain Supported Platform</b></em>'.
 * 
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getOsapi <em>OSAPI</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getOs <em>OS</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getArchitecture <em>Architecture</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getCompiler <em>Compiler</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getMicroprocessor <em>Microprocessor</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getBoard <em>Board</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getRequires <em>Requires</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevdom.impl.MIODomainSupportedPlatformImpl#getLanguages <em>Languages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MIODomainSupportedPlatformImpl extends MCommonReferenceableObjImpl implements MIODomainSupportedPlatform {
	/**
	 ...
	 * @generated
	 */
	protected MIODomainSupportedPlatformImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return mclevdomPackage.Literals.MIO_DOMAIN_SUPPORTED_PLATFORM;
	}
		...
		if (osapi != null && osapi.eIsProxy()) {
			...
			if (osapi != oldOsapi) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__OSAPI, oldOsapi, osapi));
			}
		}
		return osapi;
	}
	...
	public void setOsapi(MOperatingSystemAPI newOsapi) {
		...
		osapi = newOsapi;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__OSAPI, oldOsapi, osapi));
	}
	...
	public MOperatingSystem getOs() {
		if (os != null && os.eIsProxy()) {
			...
			if (os != oldOs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__OS, oldOs, os));
			}
		}
		return os;
	}
	...
	public void setOs(MOperatingSystem newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__OS, oldOs, os));
	}
	...
	public MArchitecture getArchitecture() {
		if (architecture != null && architecture.eIsProxy()) {
			...
			if (architecture != oldArchitecture) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__ARCHITECTURE, oldArchitecture, architecture));
			}
		}
		return architecture;
	}
	...
	public void setArchitecture(MArchitecture newArchitecture) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__ARCHITECTURE, oldArchitecture, architecture));
	}
	...
	public MCompiler getCompiler() {
		if (compiler != null && compiler.eIsProxy()) {
			...
			if (compiler != oldCompiler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__COMPILER, oldCompiler, compiler));
			}
		}
		return compiler;
	}
	...
	public void setCompiler(MCompiler newCompiler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__COMPILER, oldCompiler, compiler));
	}
	...
	public MMicroprocessor getMicroprocessor() {
		if (microprocessor != null && microprocessor.eIsProxy()) {
			...
			if (microprocessor != oldMicroprocessor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__MICROPROCESSOR, oldMicroprocessor, microprocessor));
			}
		}
	...
	public void setMicroprocessor(MMicroprocessor newMicroprocessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__MICROPROCESSOR, oldMicroprocessor, microprocessor));
	}
	...
	public MBoard getBoard() {
		if (board != null && board.eIsProxy()) {
			...
			if (board != oldBoard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__BOARD, oldBoard, board));
			}
		}
		return board;
	}
	...
	public void setBoard(MBoard newBoard) {
		...
		board = newBoard;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__BOARD, oldBoard, board));
	}
	...
	public EList<MParameter> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<MParameter>(MParameter.class, this, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<MSAI> getRequires() {
		if (requires == null) {
			requires = new EObjectResolvingEList<MSAI>(MSAI.class, this, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__REQUIRES);
		}
		return requires;
	}
	...
	public EList<MLanguage> getLanguages() {
		if (languages == null) {
			languages = new EObjectResolvingEList<MLanguage>(MLanguage.class, this, mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__LANGUAGES);
		}
		return languages;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__ATTRIBUTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__OSAPI:
				if (resolve) return getOsapi();
				return basicGetOsapi();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__OS:
				if (resolve) return getOs();
				return basicGetOs();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__ARCHITECTURE:
				if (resolve) return getArchitecture();
				return basicGetArchitecture();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__COMPILER:
				if (resolve) return getCompiler();
				return basicGetCompiler();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__MICROPROCESSOR:
				if (resolve) return getMicroprocessor();
				return basicGetMicroprocessor();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__BOARD:
				if (resolve) return getBoard();
				return basicGetBoard();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__ATTRIBUTES:
				return getAttributes();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__REQUIRES:
				return getRequires();
			case mclevdomPackage.MIO_DOMAIN_SUPPORTED_PLATFORM__LANGUAGES:
				return getLanguages();
		}
