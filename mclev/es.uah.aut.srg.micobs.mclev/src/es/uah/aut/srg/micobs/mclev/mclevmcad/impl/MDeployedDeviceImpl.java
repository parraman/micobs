...
/**
 * An implementation of the model object '<em><b>MDeployedDevice</b></em>'.
 * 
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevmcad.impl.MDeployedDeviceImpl#getDevice <em>Device</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevmcad.impl.MDeployedDeviceImpl#getParameterValueAssignments <em>ParameterValueAssignments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MDeployedDeviceImpl extends MCommonReferenceableObjImpl implements MDeployedDevice {
	/**
	...
	protected EClass eStaticClass() {
		return mclevmcadPackage.Literals.MDEPLOYED_DEVICE;
	}
		...
		if (device != null && device.eIsProxy()) {
			...
			if (device != oldDevice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, mclevmcadPackage.MDEPLOYED_DEVICE__DEVICE, oldDevice, device));
			}
		}
		return device;
	}
	...
	public void setDevice(MDevice newDevice) {
		...
		device = newDevice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevmcadPackage.MDEPLOYED_DEVICE__DEVICE, oldDevice, device));
	}
	...
	public EList<MParameterValueAssignment> getParameterValueAssignments() {
		if (parameterValueAssignments == null) {
			parameterValueAssignments = new EObjectContainmentEList<MParameterValueAssignment>(MParameterValueAssignment.class, this, mclevmcadPackage.MDEPLOYED_DEVICE__PARAMETER_VALUE_ASSIGNMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case mclevmcadPackage.MDEPLOYED_DEVICE__PARAMETER_VALUE_ASSIGNMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mclevmcadPackage.MDEPLOYED_DEVICE__DEVICE:
