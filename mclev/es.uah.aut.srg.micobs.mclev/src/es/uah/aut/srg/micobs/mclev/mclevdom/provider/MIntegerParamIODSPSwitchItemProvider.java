...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevdom.MIntegerParamIODSPSwitch} object.
 * @generated
 */
public class MIntegerParamIODSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MIntegerParamIODSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MIntegerParamIODSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MIntegerParamIODSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MIntegerParamIODSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MIntegerParamIODSPSwitch_type") :
			getString("_UI_MIntegerParamIODSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MIntegerParamIODSPSwitch.class)) {
