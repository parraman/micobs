...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevmcad.MDeploymentAlternative} object.
 * @generated
 */
public class MDeploymentAlternativeItemProvider
	 ...
	 * @generated
	 */
	public MDeploymentAlternativeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MDeploymentAlternative_deploymentPlatforms_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MDeploymentAlternative_deploymentPlatforms_feature", "_UI_MDeploymentAlternative_type"),
				 mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__DEPLOYMENT_PLATFORMS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__ATTRIBUTE_VALUE_ASSIGNMENTS);
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__LIBRARIES);
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__COMPONENTS);
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__DEPLOYMENT_ALTERNATIVES);
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__CONNECTIONS);
		}
	...
	/**
	 * This returns MDeploymentAlternative.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MDeploymentAlternative"));
	}
	...
	public String getText(Object object) {
		String label = ((MDeploymentAlternative)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MDeploymentAlternative_type") :
			getString("_UI_MDeploymentAlternative_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MDeploymentAlternative.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__ATTRIBUTE_VALUE_ASSIGNMENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__LIBRARIES,
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__COMPONENTS,
				 mclevmcadFactory.eINSTANCE.createMComponentInstance()));

		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__DEPLOYMENT_ALTERNATIVES,
				 mclevmcadFactory.eINSTANCE.createMDeploymentAlternative()));

		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_ALTERNATIVE__CONNECTIONS,
