...
/**
 * A representation of a default value assignment for a service library
 * real attribute for a given platform.
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevslib.MRealParamSLSPSwitchCase#getRange <em>Range</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.uah.aut.srg.micobs.mclev.mclevslib.mclevslibPackage#getMRealParamSLSPSwitchCase()
 * @model
 * @generated
 */
public interface MRealParamSLSPSwitchCase extends MParameterSLSPSwitchCase {
	/**
	 ...
	 * @see es.uah.aut.srg.micobs.mclev.mclevslib.mclevslibPackage#getMRealParamSLSPSwitchCase_Range()
