...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevdom.MStringParamIODSPSwitch} object.
 * @generated
 */
public class MStringParamIODSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MStringParamIODSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MStringParamIODSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MStringParamIODSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MStringParamIODSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MStringParamIODSPSwitch_type") :
			getString("_UI_MStringParamIODSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MStringParamIODSPSwitch.class)) {
