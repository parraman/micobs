...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevmcad.MDeploymentPlatform} object.
 * @generated
 */
public class MDeploymentPlatformItemProvider
	 ...
	 * @generated
	 */
	public MDeploymentPlatformItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MDeploymentPlatform_platform_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MDeploymentPlatform_platform_feature", "_UI_MDeploymentPlatform_type"),
				 mclevmcadPackage.Literals.MDEPLOYMENT_PLATFORM__PLATFORM,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_PLATFORM__PARAMETER_VALUE_ASSIGNMENTS);
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYMENT_PLATFORM__DEPLOYED_DEVICES);
		}
	...
	/**
	 * This returns MDeploymentPlatform.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MDeploymentPlatform"));
	}
	...
	public String getText(Object object) {
		String label = ((MDeploymentPlatform)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MDeploymentPlatform_type") :
			getString("_UI_MDeploymentPlatform_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MDeploymentPlatform.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_PLATFORM__PARAMETER_VALUE_ASSIGNMENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYMENT_PLATFORM__DEPLOYED_DEVICES,
				 mclevmcadFactory.eINSTANCE.createMDeployedDevice()));
	}
