...
/**
 * Class that implements the handler for opening the MCLEV Library editor.
 *
 */
public class OpenMCLEVLibrary extends OpenLibraryHandler {

	@Override
	protected URI getLibraryPlatformURI() throws LibraryManagerException {
		return MCLEVLibraryManager.getLibraryManager().getLibraryPlatformURI();
	}
