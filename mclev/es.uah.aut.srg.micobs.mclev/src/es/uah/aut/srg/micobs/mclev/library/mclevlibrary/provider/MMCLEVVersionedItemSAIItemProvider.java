...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.library.mclevlibrary.MMCLEVVersionedItemSAI} object.
 * @generated
 */
public class MMCLEVVersionedItemSAIItemProvider
	 ...
	 * @generated
	 */
	public MMCLEVVersionedItemSAIItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MMCLEVVersionedItemSAI_swInterfaceURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MMCLEVVersionedItemSAI_swInterfaceURI_feature", "_UI_MMCLEVVersionedItemSAI_type"),
				 mclevlibraryPackage.Literals.MMCLEV_VERSIONED_ITEM_SAI__SW_INTERFACE_URI,
				 true,
				 false,
				 false,
	...
	protected void addSwInterfaceVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MMCLEVVersionedItemSAI_swInterfaceVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MMCLEVVersionedItemSAI_swInterfaceVersion_feature", "_UI_MMCLEVVersionedItemSAI_type"),
				 mclevlibraryPackage.Literals.MMCLEV_VERSIONED_ITEM_SAI__SW_INTERFACE_VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((MMCLEVVersionedItemSAI)object).getVersion();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MMCLEVVersionedItemSAI.class)) {
