...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevslib.MStringParamSLSPSwitch} object.
 * @generated
 */
public class MStringParamSLSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MStringParamSLSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MStringParamSLSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MStringParamSLSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MStringParamSLSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MStringParamSLSPSwitch_type") :
			getString("_UI_MStringParamSLSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MStringParamSLSPSwitch.class)) {
