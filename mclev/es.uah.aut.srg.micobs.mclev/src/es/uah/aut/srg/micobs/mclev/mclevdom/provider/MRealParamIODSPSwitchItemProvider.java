...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevdom.MRealParamIODSPSwitch} object.
 * @generated
 */
public class MRealParamIODSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MRealParamIODSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MRealParamIODSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MRealParamIODSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MRealParamIODSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MRealParamIODSPSwitch_type") :
			getString("_UI_MRealParamIODSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MRealParamIODSPSwitch.class)) {
