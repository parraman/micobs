...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevcmp.MIntegerParamCSPSwitch} object.
 * @generated
 */
public class MIntegerParamCSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MIntegerParamCSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MIntegerParamCSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MIntegerParamCSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MIntegerParamCSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MIntegerParamCSPSwitch_type") :
			getString("_UI_MIntegerParamCSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MIntegerParamCSPSwitch.class)) {
