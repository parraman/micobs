...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevmcad.MServiceLibraryInstance} object.
 * @generated
 */
public class MServiceLibraryInstanceItemProvider
	 ...
	 * @generated
	 */
	public MServiceLibraryInstanceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MServiceLibraryInstance_library_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MServiceLibraryInstance_library_feature", "_UI_MServiceLibraryInstance_type"),
				 mclevmcadPackage.Literals.MSERVICE_LIBRARY_INSTANCE__LIBRARY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mclevmcadPackage.Literals.MSERVICE_LIBRARY_INSTANCE__ATTRIBUTE_VALUE_ASSIGNMENTS);
		}
	...
	/**
	 * This returns MServiceLibraryInstance.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MServiceLibraryInstance"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_MServiceLibraryInstance_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MServiceLibraryInstance.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MSERVICE_LIBRARY_INSTANCE__ATTRIBUTE_VALUE_ASSIGNMENTS,
