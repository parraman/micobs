...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevcmp.MParameterCSPSwitch} object.
 * @generated
 */
public class MParameterCSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MParameterCSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MParameterCSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MParameterCSPSwitch_type") :
			getString("_UI_MParameterCSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MParameterCSPSwitch.class)) {
