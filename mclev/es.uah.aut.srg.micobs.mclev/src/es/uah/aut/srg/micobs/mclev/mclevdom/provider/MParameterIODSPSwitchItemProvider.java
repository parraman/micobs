...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevdom.MParameterIODSPSwitch} object.
 * @generated
 */
public class MParameterIODSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MParameterIODSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((MParameterIODSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MParameterIODSPSwitch_type") :
			getString("_UI_MParameterIODSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MParameterIODSPSwitch.class)) {
