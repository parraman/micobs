...
/**
 * An implementation of the model object '<em><b>MMCLEVVersionedItemServiceLibrary</b></em>'.
 * 
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.library.mclevlibrary.impl.MMCLEVVersionedItemServiceLibraryImpl#getSwPackageURI <em>SwPackageURI</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.library.mclevlibrary.impl.MMCLEVVersionedItemServiceLibraryImpl#getSwPackageVersion <em>SwPackageVersion</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MMCLEVVersionedItemServiceLibraryImpl extends MMCLEVPackageVersionedItemImpl implements MMCLEVVersionedItemServiceLibrary {
	/**
	 ...
	 * @generated
	 */
	protected MMCLEVVersionedItemServiceLibraryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return mclevlibraryPackage.Literals.MMCLEV_VERSIONED_ITEM_SERVICE_LIBRARY;
	}
	...
	public void setSwPackageURI(String newSwPackageURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevlibraryPackage.MMCLEV_VERSIONED_ITEM_SERVICE_LIBRARY__SW_PACKAGE_URI, oldSwPackageURI, swPackageURI));
	}
	...
	public void setSwPackageVersion(String newSwPackageVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mclevlibraryPackage.MMCLEV_VERSIONED_ITEM_SERVICE_LIBRARY__SW_PACKAGE_VERSION, oldSwPackageVersion, swPackageVersion));
	}
