...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevdom.MEnumParamIODSPSwitch} object.
 * @generated
 */
public class MEnumParamIODSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MEnumParamIODSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MEnumParamIODSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MEnumParamIODSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MEnumParamIODSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MEnumParamIODSPSwitch_type") :
			getString("_UI_MEnumParamIODSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MEnumParamIODSPSwitch.class)) {
