...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevslib.MIntegerParamSLSPSwitch} object.
 * @generated
 */
public class MIntegerParamSLSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MIntegerParamSLSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MIntegerParamSLSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MIntegerParamSLSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MIntegerParamSLSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MIntegerParamSLSPSwitch_type") :
			getString("_UI_MIntegerParamSLSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MIntegerParamSLSPSwitch.class)) {
