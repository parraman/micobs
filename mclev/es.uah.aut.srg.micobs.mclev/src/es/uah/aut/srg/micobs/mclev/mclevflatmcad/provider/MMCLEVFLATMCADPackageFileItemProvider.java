...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevflatmcad.MMCLEVFLATMCADPackageFile} object.
 * @generated
 */
public class MMCLEVFLATMCADPackageFileItemProvider
	 ...
	 * @generated
	 */
	public MMCLEVFLATMCADPackageFileItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MMCLEVFLATMCADPackageFile.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MMCLEVFLATMCADPackageFile"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_MMCLEVFLATMCADPackageFile_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mclevflatmcadFactory.eINSTANCE.createMFlatMCAD()));
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mclevmcadFactory.eINSTANCE.createMMCADeployment()));
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mclevslibFactory.eINSTANCE.createMServiceLibrary()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mclevslibFactory.eINSTANCE.createMAbstractServiceLibrary()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_FILE__ELEMENT,
				 mclevslibFactory.eINSTANCE.createMDriverServiceLibrary()));
