...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevdom.MComponentType} object.
 * @generated
 */
public class MComponentTypeItemProvider
	 ...
	 * @generated
	 */
	public MComponentTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mclevdomPackage.Literals.MCOMPONENT_TYPE__ATTRIBUTES);
			childrenFeatures.add(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES);
		}
	...
	public String getText(Object object) {
		String label = ((MComponentType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MComponentType_type") :
			getString("_UI_MComponentType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MComponentType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__ATTRIBUTES,
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES,
				 mclevdomFactory.eINSTANCE.createMInternalPortTypeInstance()));

		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES,
				 mclevdomFactory.eINSTANCE.createMInternalClientPortTypeInstance()));

		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES,
				 mclevdomFactory.eINSTANCE.createMInternalServerPortTypeInstance()));

		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES,
				 mclevdomFactory.eINSTANCE.createMExternalPortTypeInstance()));

		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES,
				 mclevdomFactory.eINSTANCE.createMExternalClientPortTypeInstance()));

		newChildDescriptors.add
			(createChildParameter
				(mclevdomPackage.Literals.MCOMPONENT_TYPE__PORT_TYPE_INSTANCES,
				 mclevdomFactory.eINSTANCE.createMExternalServerPortTypeInstance()));
	}
