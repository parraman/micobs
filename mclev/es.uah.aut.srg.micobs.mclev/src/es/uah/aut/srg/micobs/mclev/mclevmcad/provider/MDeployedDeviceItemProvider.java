...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevmcad.MDeployedDevice} object.
 * @generated
 */
public class MDeployedDeviceItemProvider
	 ...
	 * @generated
	 */
	public MDeployedDeviceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MDeployedDevice_device_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MDeployedDevice_device_feature", "_UI_MDeployedDevice_type"),
				 mclevmcadPackage.Literals.MDEPLOYED_DEVICE__DEVICE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(mclevmcadPackage.Literals.MDEPLOYED_DEVICE__PARAMETER_VALUE_ASSIGNMENTS);
		}
	...
	/**
	 * This returns MDeployedDevice.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MDeployedDevice"));
	}
	...
	public String getText(Object object) {
		String label = ((MDeployedDevice)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MDeployedDevice_type") :
			getString("_UI_MDeployedDevice_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MDeployedDevice.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(mclevmcadPackage.Literals.MDEPLOYED_DEVICE__PARAMETER_VALUE_ASSIGNMENTS,
