 ...
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.mclevslib.MIntegerParamSLSPSwitchCase#getRange <em>Range</em>}</li>
 * </ul>
 * </p>
 *
 * @see es.uah.aut.srg.micobs.mclev.mclevslib.mclevslibPackage#getMIntegerParamSLSPSwitchCase()
 * @model
 * @generated
 */
public interface MIntegerParamSLSPSwitchCase extends MParameterSLSPSwitchCase {
	/**
	 ...
	 * @see es.uah.aut.srg.micobs.mclev.mclevslib.mclevslibPackage#getMIntegerParamSLSPSwitchCase_Range()
