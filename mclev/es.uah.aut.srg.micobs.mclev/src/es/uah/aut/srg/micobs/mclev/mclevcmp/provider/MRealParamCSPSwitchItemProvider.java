...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.mclevcmp.MRealParamCSPSwitch} object.
 * @generated
 */
public class MRealParamCSPSwitchItemProvider
	 ...
	 * @generated
	 */
	public MRealParamCSPSwitchItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns MRealParamCSPSwitch.gif.
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MRealParamCSPSwitch"));
	}
	...
	public String getText(Object object) {
		String label = ((MRealParamCSPSwitch)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MRealParamCSPSwitch_type") :
			getString("_UI_MRealParamCSPSwitch_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MRealParamCSPSwitch.class)) {
