...
/**
 * An implementation of the model object '<em><b>EDROOMDataFieldUnion</b></em>'.
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.domain.edroom.edroomdclass.impl.EDROOMDataFieldUnionImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EDROOMDataFieldUnionImpl extends EDROOMDataFieldImpl implements EDROOMDataFieldUnion {
	/**
	 ...
	 * @generated
	 */
	protected EDROOMDataFieldUnionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return edroomdclassPackage.Literals.EDROOM_DATA_FIELD_UNION;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, edroomdclassPackage.EDROOM_DATA_FIELD_UNION__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EDROOMDataDefinitionUnion newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, edroomdclassPackage.EDROOM_DATA_FIELD_UNION__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case edroomdclassPackage.EDROOM_DATA_FIELD_UNION__TYPE:
