...
/**
 * An implementation of the model object '<em><b>EDROOMDataFieldEnum</b></em>'.
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.mclev.domain.edroom.edroomdclass.impl.EDROOMDataFieldEnumImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EDROOMDataFieldEnumImpl extends EDROOMDataFieldImpl implements EDROOMDataFieldEnum {
	/**
	 ...
	 * @generated
	 */
	protected EDROOMDataFieldEnumImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return edroomdclassPackage.Literals.EDROOM_DATA_FIELD_ENUM;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, edroomdclassPackage.EDROOM_DATA_FIELD_ENUM__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(EDROOMDataDefinitionEnum newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, edroomdclassPackage.EDROOM_DATA_FIELD_ENUM__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case edroomdclassPackage.EDROOM_DATA_FIELD_ENUM__TYPE:
