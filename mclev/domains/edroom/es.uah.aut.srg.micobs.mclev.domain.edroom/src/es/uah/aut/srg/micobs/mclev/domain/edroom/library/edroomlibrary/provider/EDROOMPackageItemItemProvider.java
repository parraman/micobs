...
/**
 * This is the item provider adapter for a {@link es.uah.aut.srg.micobs.mclev.domain.edroom.library.edroomlibrary.EDROOMPackageItem} object.
 *
 * @generated
 */
public class EDROOMPackageItemItemProvider
	 ...
	 * @generated
	 */
	public EDROOMPackageItemItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((EDROOMPackageItem)object).getUri();
		return label == null || label.length() == 0 ?
			getString("_UI_EDROOMPackageItem_type") :
			getString("_UI_EDROOMPackageItem_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_ITEM__VERSIONED_ITEMS,
				 edroomlibraryFactory.eINSTANCE.createEDROOMVersionedItemDataClass()));

		newChildDescriptors.add
			(createChildParameter
				(commonPackage.Literals.MCOMMON_PACKAGE_ITEM__VERSIONED_ITEMS,
				 edroomlibraryFactory.eINSTANCE.createEDROOMVersionedItemProtocol()));
	}
